                    ...
                    echo '<div class="col mb-5" >';
                        echo '<div class="card h-100">';
                            ...
                            echo '<div class="card-body p-4">';
                                echo '<div class="text-center" id="font">';
                                    //<!-- Product name-->
                                    echo '<h5 class="fw-bolder" id="font">'. $data['Product_name'].'</h5>';
                                    //<!-- Product reviews-->
                                    echo '<div class="d-flex justify-content-center small text-warning mb-2" id="font">';
