    ...
    function time_display(id_tag, time_s) {
        ...
        if (time_s <= 0) {
            document.getElementById(id_tag).innerHTML =
                "หมดเวลาโอนเงิน <br> <button onclick=\"window.location.href='?action=cancel'\" class='btn btn-default has-spinner btn--radius-2 btn--red' type='submit'>ยกเลิก - เริ่มโอนใหม่</button>";
...
<body>
        ...
        <div class="wrapper wrapper--w680">
            <div class="card card-4">
                <div style=" background-color:#113566" align="center"><img src="pp.png" width="30%" align="center">
                    ...
                    <?php
			if($_SESSION["id_pay"]){
				echo '<a href="?Money=$money&action=exit"><img src="close.png" width="50" align="right"></a>';
			}
			...
			?></div>
                <div class="card-body">
                    ...
                    <h2 style="margin-top:-50px">ชำระด้วย PromptPay อัตโนมัติ <br>
						...
						$support->close(); 
					?></h2>
                    <div class="label" style="color:olive">! ช่วงเวลา 00:00 - 02:00
                        เป็นช่วงที่ธนาคารปรับปรุงระบบในรอบวัน อาจทำให้ไม่สามารถตรวจสอบการโอนได้ ควรกดตรวจสอบเป็นระยะ
                    </div>
                    <?php
                    ...
                    <a href="http://127.0.0.1/WebProject/tbs_module_composer-master/examples/sms.php">
                        <p class="label" align="center">[! GO ]</p>
                    </a>
                    <?php
					}else{
					if($_SESSION["id_pay"]){
                    ...
                    <button class="btn btn--radius-2 btn--green btn-default has-spinner" type="submit"
                        onclick="window.location.href='?action=confirm'">แจ้งการโอนเงิน</button>
                    <script>
                    ...
                    <form method="POST">
                        ...
                        <div class="p-t-15">
                            <div class="label" style="color:red"><?php echo $Money?> Bath</div>
                            <div class="label" style="color:red">**เตรียมแอปชำระเงินของคุณให้พร้อมก่อนกดชำระเงิน</div>
                            <button class="btn btn--radius-2 btn--green btn-default has-spinner"
                                onclick="this.form.submit();" type="submit">กดเพื่อชำระเงิน</button>
                            <button class="btn btn--radius-2 btn--green btn-default has-spinner"
                                onclick="window.history.back()" type="submit">ย้อนกลับ</button>
                        </div>
                    </form>
                    <?php
					}
    ...
    <script
        src="https://www.jqueryscript.net/demo/jQuery-Plugin-For-Built-In-Loading-Indicator-In-Buttons-Button-Loader/jquery.buttonLoader.js">
    </script>
    <script>
