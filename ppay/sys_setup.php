...
'4'=>'$conn=odbc_connect(\'Driver={SQL Server};Server=\' .$database_host. \';Database=\' . $database_db_name. \';\'
...
$_SESSION["alert_content"]="Setup เรียบร้อย หากต้องการแก้ไขค่าต่างๆ สามารถทำได้ที่ไฟล์ config.php
หากต้องการตั้งค่าใหม่ให้ลบไฟล์ config.php";
...
<form method="post">
    ...
    <p>เลขพร้อมเพย์ : <input name="pp_no"> เช่น เบอร์โทร ,บัตรปชช ,เลข E-wallet กสิกร <a
            href="https://tmweasy.tk/e_kbank.php" target="_bank">*วิธีดูเลข E-wallet</a></p>
    <p>ประเภทพร้อมเพย์ : <select name="pp_type">
            <option value="01">เบอร์โทร</option>
            <option value="02">เลขบัตร ปชช</option>
            <option value="03">กสิกร E-wallet</option>
        </select> *เลือกชนิดพร้อมเพย์ให้ถูกต้อง ถ้าผิดจะแสกน Qr ไม่ได้</p>
    <p>Con id : <input name="conid"> เลข ID ที่ได้จากการเปิดใช้งาน Qr Promptpay Api บนเว็บ tmweasy</p>
    <p>Accode : <input name="accode"> จากการเข้ารหัส User และ รหัสผ่าน ธนาคาร ที่ <a
            href="https://tmweasy.tk/encode.php" target="_bank">https://www.tmweasy.com/encode.php</a></p>

    <div><b>รูปแบบการป้อนยอดโอน</b></div>
    <p><label><input type="radio" name="money_input" value="0" checked> ลูกค้าระบุยอดเอง</label></p>
    <p><label><input type="radio" name="money_input" value="1"> แบบ List ยอด ยอดที่กำหนด <input size="40"
                name="money_list" value="50,80,100,150,300,500"> </label></p>
