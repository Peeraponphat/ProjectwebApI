        ...
        <div class="container px-4 px-lg-5 my-5">
            <div class="text-center text-dark">
                <div id="myBtnContainer">
                    <button class="btn1 active" onclick="filterSelection('Me-O')"><img src="src/meo.png" alt=""
                            width="200px" height="150px"></button>
                    <button class="btn1 active" onclick="filterSelection('Whiskas')"><img src="src/whiskas.png" alt=""
                            width="150px" height="150px"></button>
                    <button class="btn1 active" onclick="filterSelection('Ostech')"><img src="src/ostech.png" alt=""
                            width="200px" height="150px"></button>
    ...
    <section class="py-5" style="background-color:#FFF2CC;">
        <div class="container px-4 px-lg-5 mt-5" style="background-color:#FFF2CC;">
            <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center"
                ...
                <?php
                include "Connect.php";
                    $sql = "SELECT * FROM `product` WHERE `Type`='แมว';";
