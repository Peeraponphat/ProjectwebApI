<?php
    ...
    class DB_con {
        ...
        public function registration($fname, $uname, $uemail, $password)  {
            ...
            VALUES('$fname', '$uname', '$uemail', '$password')");  //using function for query data
            return $reg;
        }
        //check username and password
        public function login($uname, $password) {
            $loginquery = mysqli_query($this->dbcon, "SELECT id, fullname FROM tblusers WHERE username = '$uname' AND password ='$password'");
            return $loginquery;
        }
    }
